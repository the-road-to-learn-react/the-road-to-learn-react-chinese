...
一般来说，本书每一章都会在前一章基础上继续搭建。每一章都会教你一些新的知识点。务必不要跳过任何内容。你应该认同每一个步骤。你可以自己写出实现，然后阅读书中的内容。每一章之后，我提供了一些阅读资料和练习题。如果你真的想学好React，我非常推荐读完这些阅读资料并上手完成练习题。完成一章的学习之后，请保证自己对所学内容熟练掌握之后，再继续后面的章节。
...
最终，你会有一个完整的可以部署上线的应用。我非常渴望能看到你的杰作，如果你完成了这本书，请给我发消息。最后一章会给你很多选择来继续React的学习和应用。一般来说你会在[我的个人网站](https://www.robinwieruch.de/)找到非常多的React的相关话题。
...
既然你在看这本书，我猜你还是个React新手。真是太好了。最后我希望你能给我你的反馈，来帮助我完善学习资料，从而让所有人都掌握React。你可以直接提交代码到[GitHub](https://github.com/rwieruch/the-road-to-learn-react)，或者在[Twitter](https://twitter.com/rwieruch)给我发消息。
